defmodule GoCardlessClient.Resources.Exports do
  @moduledoc """
  GoCardlessClient Exports API.

  See https://developer.gocardless.com/api-reference/#exports for full documentation.
  """
  ...
  @doc "Creates a new exports resource."
  ...
  @doc "Retrieves a single exports by ID."
  ...
  @doc "Lists exports with optional filter params."
  ...
  @doc "Eagerly collects all exports into a list across all pages."

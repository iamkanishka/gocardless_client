defmodule GoCardlessClient.Resources.CurrencyExchangeRates do
  @moduledoc """
  GoCardlessClient Currency Exchange Rates API.

  See https://developer.gocardless.com/api-reference/#currency-exchange-rates for full documentation.
  """
  ...
  @doc "Creates a new currency exchange rates resource."
  ...
  @doc "Retrieves a single currency exchange rates by ID."
  ...
  @doc "Updates a currency exchange rates."
  ...
  @doc "Lists currency_exchange_rates with optional filter params."
  ...
  @doc "Returns a lazy `Stream` over all pages of currency_exchange_rates."
  @spec stream(Client.t(), map(), keyword()) :: Enumerable.t()
  def stream(%Client{} = client, params \\ %{}, opts \\ []) do
    Paginator.stream(client, @base_path, params, @resource_key, opts)
  end

  @doc "Eagerly collects all currency_exchange_rates into a list across all pages."

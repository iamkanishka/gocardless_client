defmodule GoCardlessClient.Resources.VerificationDetails do
  @moduledoc """
  GoCardlessClient Verification Details API.

  See https://developer.gocardless.com/api-reference/#verification-details for full documentation.
  """
  ...
  @doc "Creates a new verification details resource."
  ...
  @doc "Retrieves a single verification details by ID."
  ...
  @doc "Updates a verification details."
  ...
  @doc "Lists verification_details with optional filter params."
  ...
  @doc "Returns a lazy `Stream` over all pages of verification_details."
  @spec stream(Client.t(), map(), keyword()) :: Enumerable.t()
  def stream(%Client{} = client, params \\ %{}, opts \\ []) do
    Paginator.stream(client, @base_path, params, @resource_key, opts)
  end

  @doc "Eagerly collects all verification_details into a list across all pages."

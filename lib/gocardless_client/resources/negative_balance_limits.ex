defmodule GoCardlessClient.Resources.NegativeBalanceLimits do
  @moduledoc """
  GoCardlessClient Negative Balance Limits API.

  See https://developer.gocardless.com/api-reference/#negative-balance-limits for full documentation.
  """
  ...
  @doc "Creates a new negative balance limits resource."
  ...
  @doc "Retrieves a single negative balance limits by ID."
  ...
  @doc "Updates a negative balance limits."
  ...
  @doc "Lists negative_balance_limits with optional filter params."
  ...
  @doc "Returns a lazy `Stream` over all pages of negative_balance_limits."
  @spec stream(Client.t(), map(), keyword()) :: Enumerable.t()
  def stream(%Client{} = client, params \\ %{}, opts \\ []) do
    Paginator.stream(client, @base_path, params, @resource_key, opts)
  end

  @doc "Eagerly collects all negative_balance_limits into a list across all pages."

defmodule GoCardlessClient.Resources.PaymentAccounts do
  @moduledoc """
  GoCardlessClient Payment Accounts API.

  See https://developer.gocardless.com/api-reference/#payment-accounts for full documentation.
  """

  alias GoCardlessClient.{Client, Paginator, Resource}

  @resource_key "payment_accounts"
  @base_path "/payment_accounts"

  @doc "Creates a new payment accounts resource."
  ...
  @doc "Retrieves a single payment accounts by ID."
  ...
  @doc "Updates a payment accounts."
  ...
  @doc "Lists payment_accounts with optional filter params."
  ...
  @doc "Returns a lazy `Stream` over all pages of payment_accounts."
  @spec stream(Client.t(), map(), keyword()) :: Enumerable.t()
  def stream(%Client{} = client, params \\ %{}, opts \\ []) do
    Paginator.stream(client, @base_path, params, @resource_key, opts)
  end

  @doc "Eagerly collects all payment_accounts into a list across all pages."

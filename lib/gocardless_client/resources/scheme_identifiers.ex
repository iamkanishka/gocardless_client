defmodule GoCardlessClient.Resources.SchemeIdentifiers do
  @moduledoc """
  GoCardlessClient Scheme Identifiers API.

  See https://developer.gocardless.com/api-reference/#scheme-identifiers for full documentation.
  """

  alias GoCardlessClient.{Client, Paginator, Resource}

  @resource_key "scheme_identifiers"
  @base_path "/scheme_identifiers"

  @doc "Creates a new scheme identifiers resource."
  ...
  @doc "Retrieves a single scheme identifiers by ID."
  ...
  @doc "Updates a scheme identifiers."
  ...
  @doc "Lists scheme_identifiers with optional filter params."
  ...
  @doc "Returns a lazy `Stream` over all pages of scheme_identifiers."
  @spec stream(Client.t(), map(), keyword()) :: Enumerable.t()
  def stream(%Client{} = client, params \\ %{}, opts \\ []) do
    Paginator.stream(client, @base_path, params, @resource_key, opts)
  end

  @doc "Eagerly collects all scheme_identifiers into a list across all pages."
